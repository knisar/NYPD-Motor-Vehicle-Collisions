...
LOAD DATA LOCAL INFILE '/path to your csv/NYPD2.csv' 

INTO TABLE  ACCIDENT_DATA FIELDS TERMINATED
 BY ',' ESCAPED
 BY '"' 
 IGNORE 1 LINES;
 
UPDATE ACCIDENT_DATA SET DATES = STR_TO_DATE(DATES, '%c/%e/%Y %H:%i');
ALTER TABLE ACCIDENT_DATA MODIFY DATES date;
